...
return new class extends Migration
{
    ...
    {
        Schema::create("purchase_down_payments_{$this->year}", function (Blueprint $table) {
            $table->id();
            ...
            // Nilai
            $table->decimal('purchase_order_amount', 15, 4);
    ...
    {
        Schema::dropIfExists("purchase_down_payment_{$this->year}");
    }
};
