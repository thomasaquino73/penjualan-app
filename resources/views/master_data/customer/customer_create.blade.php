                                    ...
                                    <div class="col-lg-6">
                                        <div class="row">
                                            <div class="col-md-12 col-sm-12 mb-3">
                                                ...
                                                <textarea id="alamat_tagihan" name="alamat_tagihan" class="form-control" placeholder="Enter Billing Address"></textarea>
                                    ...
                                    <div class="col-md-6 col-sm-12">
                                        <div class="row">
                                            ...
                                            <div class="col-md-12 col-sm-12 mb-3">
                                                ...
                                                <textarea id="alamat_pengiriman" name="alamat_pengiriman" class="form-control" placeholder="Enter Main Address"></textarea>
