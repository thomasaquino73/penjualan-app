        ...
        <div class="modal-dialog modal-dialog-centered1 modal-simple ">
            <div class="modal-content p-3 p-md-5">
                <div class="modal-body">
                    ...
                    <form id="postForm" name="postForm" method="POST" action="{{ route('fob.store') }}">
                        @csrf
                        <input type="text" name="id" id="id" hidden>
                        <div class="row">
                            <div class="col-12 mb-3">
                                <label class="form-label w-100" for="detail">FOB Name</label>
                                <div class="input-group input-group-merge">
                                    <input id="detail" name="detail" class="form-control credit-card-mask"
                                        type="text" placeholder="Enter FOB Name" />
                                </div>
