    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="row">
            <div class="col-xl-12 col-lg-5 col-md-5">
                ...
                <div class="card mb-4">
                    <div class="card-body">
                        <strong class="card-text text-uppercase">About</strong>
                        <ul class="list-unstyled mb-4 mt-3">
                            <li class="d-flex align-items-center mb-3">
                                <i class="ti ti-user text-heading"></i><span class="fw-medium mx-2 text-heading">Full
                                    Name:</span> <span>{{ $user->fullname }}</span>
                            </li>
                            <li class="d-flex align-items-center mb-3">
                                <i class="ti ti-user text-heading"></i><span class="fw-medium mx-2 text-heading">Nick
                                    Name:</span> <span>{{ $user->nickname }}</span>
                            </li>
                            <li class="d-flex align-items-center mb-3">
                                <i
                            ...
                            <li class="d-flex align-items-center mb-3">
                                <i class="ti ti-crown text-heading"></i><span
                                    class="fw-medium mx-2 text-heading">Roles:</span> <span>
                                    @foreach (Auth::user()->getRoleNames() as $role)
                                        {{ $role }}
                                        @if (!$loop->last)
                                            |
                            ...
                            <li class="d-flex align-items-center mb-3">
                                <i
                                    class="ti {{ $user->gender == 'Male' ? 'ti-gender-male text-success' : 'ti-gender-male text-danger' }}"></i>
                        ...
                        <strong class="card-text text-uppercase">Contact Information</strong>
                        <ul class="list-unstyled mb-4 mt-3">
                            <li class="d-flex align-items-center mb-3">
