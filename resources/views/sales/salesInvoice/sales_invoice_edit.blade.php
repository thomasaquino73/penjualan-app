...
@push('scripts')
    @push('scripts')
        <script>
            ...
            const downPaymentId = @json($model->pelunasan_id);
        ...
        <script>
            ...
            function loadReference(selectedId = null) {
                ...
                if (type === 'proforma') {
                    ...
                    $('#total_dp').val(formatRupiah(totalDP || 0));
                    return;
                }
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        $.each(response, function(key, value) {
                            ...
                            let selected =
                                selectedId &&
                                String(selectedId) === String(value.id);
                            ...
                            select.append(
                                $('<option>', {
                                    ...
                                    text: value.code +
                                        ...
                                        value.date +
                                        ' (Rp ' +
                                        formatRupiah(value.amount || 0) +
                                        ')',
                                    selected: selected
                                })
                                .attr('data-amount', value.amount || 0)
                                .attr(
                                    'data-sales-order-id',
                        ...
                        if (selectedId) {
                            ...
                            if (option.length) {
                                ...
                                $('#sales_order_id').val(
                                    option.attr('data-sales-order-id') || ''
                                );
                            }
