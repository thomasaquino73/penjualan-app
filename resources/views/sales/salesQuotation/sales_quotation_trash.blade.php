        ...
        <div
            ...
            <div class="col-12 col-lg-5">
                <div
                    ...
                    <a href="{{ route('sales-quotation.index') }}" class="btn btn-secondary btn-sm ">
                        <i class="ti ti-chevron-left me-1"></i> Back
                    </a>

                    @canany(['sales_quotation-restore'])
    ...
    <script>
        $(document).ready(function() {
            ...
            var table = new DataTable('#table', {
                ...
                ajax: {
                    url: '{{ route('sales-quotation.trash') }}',
                    data: function(d) {
            ...
            $('body').on('click', '.restore', function() {
                ...
                Swal.fire({
                    title: 'Restore this sales quotation?',
                    icon: 'question',
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            url: `/sales-quotation/restore/${id}`,
                            type: 'PUT',
                            data: {
                                _token: token
                            },
            ...
            $('#restoreSelected').on('click', function() {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            url: '/sales-quotation/restore-multiple',
                            type: 'POST',
                            data: {
                                ids: ids,
                                _token: '{{ csrf_token() }}'
