                            ...
                            <div class="row">
                                ...
                                <div class="col-6 mb-3">
                                    ...
                                    <div class="input-group input-group-merge">
                                        ...
                                        <input type="text" name="sales_order_code" id="sales_order_code"
                            ...
                            <div class="col-12 mb-3">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-8">
                                        <div class="input-group input-group-merge">
                                            <span
                                                class="input-group-text">{{ $company->currency?->symbol ?? 'Rp' }}</span>
                                            <input type="number" id="discount_all" name="discount_all"
