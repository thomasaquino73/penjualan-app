        ...
        <div class="card-body table-responsive p-3">
            <form action="{{ route('sales-order.store') }}" method="POST" id="postForm" enctype="multipart/form-data">
                ...
                <div class="row mb-5">
                    ...
                    {{-- <div class="col-lg-3">
                        <div class="col-12 mb-3">
                            <label class="form-label" for="biaya_lai"> <strong>Biaya Lain-lain</strong></label>
                            <div class="input-group input-group-merge">
                                <span class="input-group-text">{{ $company->currency?->symbol ?? 'Rp' }}</span>
                                <input type="number" id="biaya_lai" name="biaya_lai" class="form-control"
                                    placeholder="0">
                            </div>
                        </div>
                    </div> --}}
            ...
            $("#btnSubmitSelected").on("click", function() {
                ...
                checkedBoxes.each(function() {
                    ...
                    let item = {
                        ...
                        order_code: $(this).data("quotation_code"),
                    };
