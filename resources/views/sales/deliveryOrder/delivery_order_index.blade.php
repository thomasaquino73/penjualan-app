    ...
    <script>
        $(document).ready(function() {
            ...
            $('body').on('click', '#delivered', function() {
                ...
                Swal.fire({
                    title: 'Are you sure?',
                    text: "Want to delivered this item : " + name,
                    icon: 'warning',
                    showCancelButton: true,
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            url: `/delivery-order/${id}/delivered`,
                            type: "Patch",
                            cache: false,
                            data: {
                                _token: token
                            ...
                            success: function(response) {
                                table.draw();
                                toastr.success('Delivered Item Successfully', '', {
                                    timeOut: 1500,
                                    progressBar: true,
                                    closeButton: false,
                                    positionClass: 'toast-top-right',
