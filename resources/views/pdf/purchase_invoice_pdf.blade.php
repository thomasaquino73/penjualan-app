...
<head>
    <meta charset="UTF-8">
    <title>Purchase Invoice - {{ $model->purchase_invoice_code }}</title>
    ...
    <table class="info-table" style="margin-top: 20px; width:100%">
        <tr>
            ...
            <td style="width: 50%; vertical-align: top; padding-left: 20px;">
                <div class="po-box-title">Purchase Invoice</div>
                <table style="width:100%;">
                    ...
                    <tr>
                        ...
                        <td width="10">:</td>
                        <td>{{ date('d M Y', strtotime($model->datePO)) }}</td>
                    </tr>
                    <tr>
                        ...
                        @foreach ($downPayments as $payment)
                            <tr>
                                <td>
                                    ...
                                    <small>
                                        @if (!empty($payment->purchase_downpayment_date))
                                            {{ \Carbon\Carbon::parse($payment->purchase_downpayment_date)->format('d/m/Y') }}
                                        @else
                                            -
                                        @endif
                                    </small>
