        ...
        <tr>
            <td style="width: 50%; vertical-align: top;">
                ...
                <div class="recipient-box">
                    <strong>{{ $purchaseDownPayment->supplierID->nama_supplier }}</strong><br>
                    {!! nl2br(e($purchaseDownPayment->address)) !!}
                </div>
            </td>
            <td style="width: 50%; vertical-align: top; padding-left: 20px;">
                <div class="po-box-title">Uang Muka Pembelian</div>
                <table style="width:100%;">
                    <tr>
                        <td width="70">Nomor</td>
                        <td width="10">:</td>
                        <td>{{ $purchaseDownPayment->purchase_downpayment_code }}</td>
                    </tr>
                    <tr>
                        <td width="70">Tanggal</td>
                        <td width="10">:</td>
                        <td>{{ date('d M Y', strtotime($purchaseDownPayment->purchase_downpayment_date)) }}</td>
                    </tr>
                    <tr>
                        <td width="70">Nomor Invoice</td>
                        <td width="10">:</td>
                        <td>{{ $purchaseDownPayment->invoice_number }}</td>
                    </tr>
                    <tr>
    ...
    <div class="signature-section " style="margin-top:14px">
        <table style="width:100%; table-layout:fixed;">
            ...
            ">
                ...
                <td style="width:25%; text-align:center; vertical-align:top;">
                    <div class="approval-title">Supplier,</div>
                    <div style="height:70px;"></div>
