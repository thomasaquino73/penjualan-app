        ...
        <div
            ...
            <div class="col-12 col-lg-5">
                <div
                    ...
                    @canany(['purchase_down_payment-create'])
                        <a href="{{ route('purchase-down-payment.create') }}" class="btn btn-sm btn-primary">
                            <i class="ti ti-plus me-1"></i> Add Data
                        </a>
                    @endcanany
                    @canany(['purchase_down_payment-trash'])
                        <a href="{{ route('purchase-down-payment.trash') }}" class="btn btn-sm btn-secondary">
    ...
    <script>
        $(document).ready(function() {
            ...
            var table = new DataTable('#table', {
                ...
                ajax: {
                    url: '{{ route('purchase-down-payment.index') }}',
                    data: function(d) {
            ...
            $('#deleteSelected').on('click', function() {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            url: '/purchase-down-payment/delete-multiple',
                            type: 'POST',
                            data: {
                                ids: ids,
                                _token: '{{ csrf_token() }}'
