        ...
        <div class="modal-dialog modal-md">
            <div class="modal-content">
                ...
                <form id="formPrDetail">
                    ...
                    <input type="hidden" name="receive_item_detail_id" id="modal_receive_item_detail_id">
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="col-md-12 col-sm-12 mb-3">
                                ...
                                <small id="po-history-helper" class="form-text text-muted"
                                    style="font-size: 11px;">Pilih
                            ...
                            <div class="col-md-12 col-sm-12 mb-3">
                                <label class="form-label" for="amount">Total Price</label>
                                <div class="input-group input-group-merge">
                                    <span class="input-group-text">{{ $company->symbol ?? 'Rp' }}</span>
                                    <input type="number" id="amount" name="amount" class="form-control"
                                        step="any" placeholder="0" min="0" readonly>
                                </div>
