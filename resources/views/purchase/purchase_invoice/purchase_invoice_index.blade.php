        ...
        <div
            ...
            <div class="col-12 col-lg-5">
                <div
                    ...
                    @canany(['purchase_invoice-delete'])
        ...
        $(document).ready(function() {
            ...
            $('#deleteSelected').on('click', function() {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            url: '/purchase-invoice/delete-multiple',
                            type: 'POST',
                            data: {
                                ids: ids,
                                _token: '{{ csrf_token() }}'
            ...
            $(document).on('click', '.btn-submit-po', function() {
                let id = $(this).data('id');
                let url = "{{ route('purchase-invoice.submit', ':id') }}".replace(':id', id);
            ...
            $(document).on('click', '.btn-approval-po', function() {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            url: '/purchase-invoice/change-status/' + id,
                            type: "POST",
                            data: {
                                _token: "{{ csrf_token() }}",
                                id: id,
            ...
            $(document).on('click', '.btn-send-supplier', function() {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        $.ajax({
                            url: '/purchase-invoice/send-supplier/' + id,
                            type: 'POST',
                            data: {
