        ...
        <div class="card-body table-responsive p-3">
                        ...
                        <div class="col-md-12">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control mb-2"
                                    value="{{ $model->supplier->nama_supplier }}" disabled>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <label class="form-label">Address</label>
                            <textarea name="alamat" id="alamat" cols="" rows="5" class="form-control" disabled
                                placeholder="Address">{{ $model->shipping_address }}</textarea>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-6 mb-3">
                            ...
                            <input type="text" name="" id="" class="form-control"
                                value="{{ isset($model) ? $model->datePO : date('d-m-Y') }}" disabled>
                        </div>
                        <div class="col-6 mb-3">
                            <label class="form-label">Delivery Date<small class="text-danger">*</small> </label>
                            <input type="text" name="" id="" class="form-control"
                                placeholder="Select Date"
                                value="{{ $model->tanggal_kirim ? Carbon\Carbon::parse($model->tanggal_kirim)->format('d-m-Y') : '' }}"
                                disabled>
                        </div>
                        <div class="col-6 mb-3">
                        ...
                        <div class="col-6 mb-3">
                            <label class="form-label">Payment Term<small class="text-danger">*</small> </label>
                            <input type="text" name="term" id="term" class="form-control"
                                value="{{ $model->paymentTerm ? $model->paymentTerm->nama : '' }}" disabled>
                        ...
                        <div class="col-6 mb-3">
                            ...
                            <input type="text" name="ship_via" id="ship_via" class="form-control"
                                value="{{ $model->ship->nama }}" disabled>
            ...
            <div class="row mb-5">
                ...
                <div class="col-lg-4">
                        ...
                        <div class="row">
                            <div class="col-4">
                                <div class="input-group input-group-merge">
                                    ...
                                    <input type="number" id="" name="" min="0" step="any"
                    ...
                    <div class="col-12 mb-3">
                        <label class="form-label" for=""> Tax (11%)</label>
                        <div class="input-group input-group-merge">
                            <span class="input-group-text">{{ $company->currency?->symbol ?? 'Rp' }}</span>
                    ...
                    <div class="col-12 mb-3">
                        ...
                        <div class="input-group input-group-merge">
                            <span class="input-group-text">{{ $company->currency?->symbol ?? 'Rp' }}</span>
                            <input type="number" id="" name="" class="form-control" placeholder="0"
                                readonly value="{{ number_format(old('', $model->grand_total), 0, ',', '.') }}" readonly>
                        </div>
