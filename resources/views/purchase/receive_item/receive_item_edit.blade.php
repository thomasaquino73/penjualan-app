...
@section('konten')
    ...
    <div class="card">
        ...
        <div class="card-body table-responsive p-3">
            <form action="{{ route('receive-item.update', $model->id) }}" method="POST" id="postForm"
                                        ...
                                        <select name="supplier_id" id="supplier_id" class="form-select select2"
                                            ...
                                            @foreach ($supplier as $supp)
                                                <option value="{{ $supp->id }}"
                                                    ...
                                                    data-provinsi="{{ $supp->provinsi }}" data-negara="{{ $supp->negara }}"
                            ...
                            <div class="col-6 mb-3">
                                ...
                                <div class="input-group input-group-merge">
                                    ...
                                    <input type="text" name="receive_item_code" id="receive_item_code"
                                        class="form-control" value="{{ $model->receive_item_code }}">
                                </div>
                            ...
                            <div class="col-6 mb-3">
                                ...
                                <div class="input-group input-group-merge">
                                    ...
                                    <input type="text" name="receive_item_date" id="receive_item_date"
                                        ...
                                        value="{{ $model->receive_item_date ? \Carbon\Carbon::parse($model->receive_item_date)->format('d-m-Y') : '' }}">
                                </div>
                    ...
                    <div class="nav-align-left mb-4">
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane fade" id="navs-pills-left-profile" role="tabpanel">
                                @include('purchase.receive_item.part.info_pesanan_edit')
                ...
                @foreach ($jsonDetails as $detail)
                    {
                        ...
                        'order_code': '{{ $detail['order_code'] ?? '' }}', // Ini yang Anda cari
                        ...
                        buttons: [{
                            ...
                            },
                            {
                                ...
                                action: function(e, dt, node, config) {
                                    ...
                                    let totalLain = parseFloat(data.total_diambil_lainnya || 0);
                                    let qtySekarang = parseFloat(data.quantity || 0);

                                    // 3. Update Title & UI Modal dengan informasi total serapan lain
                                    $("#modalTitle").html(`
                                            Edit Entry |
                                            <span class="badge bg-primary">Kuota Asli: ${kuotaAwalPr}</span>
                                            <span class="badge bg-warning text-dark">Sudah diterima RI lain: ${totalLain}</span>
                                        `);
                                    ...
                                    // Logika: Sisa yang tersedia (dari tabel PO) + Qty yang sedang diedit (karena akan di-overwrite)
