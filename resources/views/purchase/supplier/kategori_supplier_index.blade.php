        ...
        <div class="modal-dialog modal-dialog-centered1 modal-simple ">
            <div class="modal-content p-3 p-md-5">
                <div class="modal-body">
                    ...
                    <form id="postForm" name="postForm" method="POST" action="{{ route('kategori-supplier.store') }}">
                        @csrf
    ...
    <script>
        $(document).ready(function() {
            ...
            var table = new DataTable('#table', {
                ...
                ajax: '{{ route('kategori-supplier.index') }}',
                columns: [{
                        data: 'cekbok',
                        name: 'cekbok',
                        orderable: false,
            ...
            $('#deleteSelected').on('click', function() {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            url: '/kategori-supplier/delete-multiple',
                            type: 'POST',
                            data: {
                                ids: ids,
                                _token: '{{ csrf_token() }}'
