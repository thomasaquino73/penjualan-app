...
@section('konten')
    ...
    <div class="card">
        ...
        <div class="card-body table-responsive p-3">
            <form action="{{ route('item-transfer.update', $model->id) }}" method="POST" id="postForm"
                        ...
                        <div class="row">
                            ...
                            <div class="col-6 mb-3">
                                ...
                                <input type="text" name="transfer_date" id="transfer_date" class="form-control"
                                    value="{{ Carbon\Carbon::parse($model->transfer_date)->format('d-m-Y') }}">
                            ...
                            <div class="col-6 mb-3">
                                ...
                                <select name="from_warehouse_id" id="from_warehouse_id" class="from-select select2"
                                    ...
                                    @foreach ($fromWarehouse as $fw)
                                        <option value="{{ $fw->id }}"
                                            {{ $model->from_warehouse_id == $fw->id ? 'selected' : '' }}>
                                            {{ $fw->nama_gudang }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-6 mb-3">
                                ...
                                <select name="to_warehouse_id" id="to_warehouse_id" class="from-select select2"
                                    ...
                                    @foreach ($toWarehouse as $tw)
                                        <option value="{{ $tw->id }}"
                                            {{ $model->to_warehouse_id == $fw->id ? 'selected' : '' }}>
                                            {{ $tw->nama_gudang }}</option>
                                    @endforeach
                                </select>
