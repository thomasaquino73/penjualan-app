...
@section('konten')
    ...
    <div class="d-flex flex-column flex-md-row align-items-md-center justify-content-between mb-4">
        ...
        <div class="mt-3 mt-md-0">
            <a href="{{ route('data-barang.index') }}" class="btn btn-outline-secondary btn-sm rounded-pill px-3 shadow-sm">
                ...
                <div class="card-body text-center p-4">
                    ...
                    <div class="bg-light p-3 rounded-3">
                        ...
                        <h4 class="text-primary fw-bold mb-0">
                            {{ $detail->primary_price ? format_uang(convert_currency($detail->primary_price, $detail->currency_id ?? 1)) : 'N/A' }}
                        </h4>
                    </div>
                            ...
                            <div class="table-responsive">
                                <table class="table table-hover mb-0">
                                    <tbody>
                                        ...
                                        <tr class="align-middle">
                                            <th class="ps-4 py-3 text-muted fw-normal">Minimum Stock</th>
                                            <td class="fw-medium text-dark ps-2">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane fade show active" id="navs-top-home" role="tabpanel">
                            <table class="table table-hover mb-0" id="table_history">
                                ...
                                <tbody>
                                    @foreach ($mutations as $index => $stock)
                                        <tr class="align-middle">
