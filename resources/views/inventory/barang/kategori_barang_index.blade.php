        ...
        <div class="modal-dialog modal-dialog-centered1 modal-simple ">
            <div class="modal-content p-3 p-md-5">
                <div class="modal-body">
                    ...
                    <form id="postForm" name="postForm" method="POST" action="{{ route('kategori-barang.store') }}">
                        @csrf
    ...
    <script>
        $(document).ready(function() {
            ...
            $('body').on('click', '.editPost', function(a) {
                ...
                $.ajax({
                    type: "GET",
                    url: "{{ url('kategori-barang') }}/" + id + "/edit",
                    data: {
                        id: id
                    },
                    dataType: 'json',
            ...
            $('#deleteSelected').on('click', function() {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            url: '/kategori-barang/delete-multiple',
                            type: 'POST',
                            data: {
                                ids: ids,
                                _token: '{{ csrf_token() }}'
