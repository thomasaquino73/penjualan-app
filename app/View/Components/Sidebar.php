    ...
    public function __construct()
    {
        $this->links = [
            ...
            [
                ...
                'route' => 'sales-receipt.index',
                'icon' => 'ti ti-receipt',
                'pattern' => 'sales-receipt.*',
                'active' => true,
                'roles' => ['Super Admin'],
            ...
            [
                'type' => 'single',
                'name' => 'PEMBELIAN',
                'route' => 'purchase-reports.index',
                'icon' => 'ti ti-file',
                'pattern' => 'purchase-reports.*',
                'active' => true,
                'roles' => ['Super Admin'],
                'permissions' => ['purchase_reports-browse'],
            ],
            [
                'type' => 'single',
                'name' => 'PENJUALAN',
                ...
                'active' => true,
                'roles' => ['Super Admin'],
                'permissions' => ['sales_reports-browse'],
            ],
            [
                'type' => 'section',
                'label' => 'ARSIP',
