...
class fobController extends Controller
{
    public function __construct()
    {
        $this->middleware(function ($request, $next) {
            ...
            $permissionMap = [
                'fob.index' => 'fob-browse',
                'fob.show' => 'fob-read',
                'fob.create' => 'fob-create',
                'fob.store' => 'fob-create',
                'fob.edit' => 'fob-edit',
                'fob.update' => 'fob-edit',
                'fob.destroy' => 'fob-delete',
            ];
    ...
    {
        $data = BasicCodeDetail::where('master_id', 7)->get();
    ...
    public function store(FobRequest $request)
    {
        try {
            $id = $request->input('id');
            $data = $request->all();
