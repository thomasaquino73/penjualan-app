...
class BrandController extends Controller
{
    public function __construct()
    {
        $this->middleware(function ($request, $next) {
            ...
            $permissionMap = [
                'brand.index' => 'brand-browse',
                'brand.show' => 'brand-read',
                'brand.create' => 'brand-create',
                'brand.store' => 'brand-create',
                'brand.edit' => 'brand-edit',
                'brand.update' => 'brand-edit',
                'brand.destroy' => 'brand-delete',
            ];
    ...
    {
        $data = BasicCodeDetail::where('master_id', 11)->get();
        ...
        return view('inventory.barang.brand_index', $x);
    }
