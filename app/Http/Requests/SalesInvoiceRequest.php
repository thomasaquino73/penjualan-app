...
class SalesInvoiceRequest extends FormRequest
{
    ...
    public function message(): array
    {
        return [
            ...
            'sales_invoice_code.required' => 'Code is required',
            'sales_invoice_code.unique' => 'Code has already been taken',
            'sales_invoice_date.required' => 'Date is required',
            'sales_invoice_date.date' => 'Date must be a valid date',
